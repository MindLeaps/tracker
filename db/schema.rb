...
ActiveRecord::Schema.define(version: 20170824005016) do
  ...
  create_table "grade_descriptors", id: :serial, force: :cascade do |t|
  ...
  create_table "lessons", id: :serial, force: :cascade do |t|
    ...
    t.integer "subject_id", null: false
    t.datetime "deleted_at"
    t.index ["group_id", "subject_id", "date"], name: "index_lessons_on_group_id_and_subject_id_and_date", unique: true, where: "(deleted_at IS NULL)"
  ...
  create_table "student_images", id: :serial, force: :cascade do |t|
    t.string "image"
    t.integer "student_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "students", id: :serial, force: :cascade do |t|
    ...
    t.index ["profile_image_id"], name: "index_students_on_profile_image_id"
  end
  ...
  add_foreign_key "students", "student_images", column: "profile_image_id"
end
