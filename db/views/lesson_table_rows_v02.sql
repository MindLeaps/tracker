...
SELECT l.*, group_name, chapter_name, subject_name, student_count AS group_student_count, COUNT(DISTINCT(g.student_id)) as graded_student_count, ROUND(AVG(g.mark), 2) as average_mark FROM lessons l
