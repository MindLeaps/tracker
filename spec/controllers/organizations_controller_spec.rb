...
RSpec.describe OrganizationsController, type: :controller do
  ...
  describe '#update' do
    ...
    describe 'successful update' do
      before :each do
        post :update, params: { id: existing_org.id, organization: { organization_name: 'Updated Org', mlid: 'UP1', country: 'Test Country' } }
      end
      ...
      it 'updates the name and MLID of an existing org' do
        ...
        expect(existing_org.country).to eq 'Test Country'
      end
    end
